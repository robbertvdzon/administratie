...
internal class CheckAndFixServiceTest2 {
    ...
    private fun buildFactuur(nummer: String, ex: Double, perc: Double): Factuur {
        return Factuur(
                ...
                factuurRegels=Arrays.asList(
                        FactuurRegel(aantal=java.math.BigDecimal.ONE,stuksPrijs=java.math.BigDecimal.valueOf(ex),btwPercentage=java.math.BigDecimal.valueOf(perc))
                )
        )
    }
